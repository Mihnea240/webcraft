...
export default class WebcraftPlayer extends HTMLElement {
	static css = (function () {
	...
	constructor() {
		...
		this.shadowRoot.innerHTML = WebcraftPlayer.shadowDom;
		this.shadowRoot.adoptedStyleSheets = [WebcraftPlayer.css];
...
customElements.define('webcraft-player', WebcraftPlayer);